...
public class MapExercise {
    public static void main(String[] args) {
        ...
        List<String> cleanedPunctuation = punctuation(text);
        List<String> splitText = split(String.valueOf(cleanedPunctuation));
...
////FIRST SOLUTION
//    Map<String, Integer> result = countWordsRepetition(splitStringToWords(text));
//   printMap(result);
//}

// TODO: refactor with lambda and streams
